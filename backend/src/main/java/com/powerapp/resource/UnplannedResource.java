...
public class UnplannedResource {
    private static final Logger log = LoggerFactory.getLogger(UnplannedResource.class);

    private final UnplannedRepository unplannedItems;
    private final SprintRepository sprints;
    private final CurrentUser currentUser;

    public UnplannedResource(UnplannedRepository unplannedItems, SprintRepository sprints, CurrentUser currentUser) {
