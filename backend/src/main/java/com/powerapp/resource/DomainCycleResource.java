...
public class DomainCycleResource {
    private static final Logger log = LoggerFactory.getLogger(DomainCycleResource.class);

    private final DomainCycleRepository domainCycles;
    private final CurrentUser currentUser;

    public DomainCycleResource(DomainCycleRepository domainCycles, CurrentUser currentUser) {
